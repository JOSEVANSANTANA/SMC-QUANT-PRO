...
COMUM = [
    ...
    "tests/test_versao_e_fundo_do_orbe.py",
    ...
    "tests/test_captura_no_mac.py",
    "tests/test_registro_legivel.py",
    "tests/test_mesa_multiativo.py",
    "tests/test_excluir_lancamento.py",
    "tests/test_quatro_ativos.py",
